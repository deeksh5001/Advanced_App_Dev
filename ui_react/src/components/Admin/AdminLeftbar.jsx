import { AlignStartVertical, Book, Calendar, CreditCard, Home, SquarePlus, Users } from 'lucide-react';
...
const AdminLeftbar = () => {
    const links=[
        ...
        },
        {
          name:'Add Event',
          path:'/admin/addEvent',
          icon: <SquarePlus size={20} color="#800080" /> // Using Lucide React icon for Events
        },
        {
          name:'Events',
          path:'/admin/Events',
          icon: <AlignStartVertical size={20} color="#800080" /> // Using Lucide React icon for My Bookings
        },
        {
          name:'All Bookings',
          path:'/admin/Bookings',
        ...
        },
        {
          name:'All Users',
          path:'/admin/users',
          icon: <Users size={20} color="#800080" /> // Using Lucide React icon for My Payments
        },
    ];
