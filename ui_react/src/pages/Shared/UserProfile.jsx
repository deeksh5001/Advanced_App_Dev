      ...
      <div class="mx-auto container  shadow-md">
        <div class="bg-gray-100 p-4 border-t-2 bg-opacity-5 border-purple-500 rounded-t">
          <div class="max-w-sm mx-auto md:w-full md:mx-0">
            <div class="inline-flex items-center space-x-4">
              ...
              <h1 class="text-gray-600 font-semibold">My profile</h1>
            </div>
          </div>
        </div>
        <div class="bg-white space-y-6">
          ...
          <div class="md:inline-flex w-full space-y-4 md:space-y-0 p-5 text-gray-500 items-center">
            ...
            <div class="md:w-8/12 w-full md:pl-9 max-w-sm mx-auto space-y-5 md:inline-flex pl-2">
                    ...
                    <div class="items-center mt-8 sm:mt-14 text-[#202142]">
                        ...
                        <div class="mb-2 sm:mb-6">
                            ...
                            <input type="email" id="email"
                                ...
                                placeholder="your.email@mail.com" value={localStorage.email} xrequired/>
                        </div>
                            ...
                            <div class="mb-2 sm:mb-6">
                                ...
                                <input type="text" id="name"
                                    class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 "
                                    placeholder="Your first name" value="Deeksha S" required/>
                            </div>
