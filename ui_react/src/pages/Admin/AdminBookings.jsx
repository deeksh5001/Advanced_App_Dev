              ...
              <tbody>
                  ...
                  <tr className="bg-white-500 border-b border-blue-400">
                      ...
                      <td className="px-6 py-4">
                          <select className="block border p-1 border-gray-300 rounded-sm focus:ring-primary-600 focus:border-primary-600 dark:border-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                  ...
                  <tr className="bg-white-500 border-b border-blue-400">
                      ...
                      <td className="px-6 py-4">
                          <select className="block border border-gray-300 rounded-sm p-1 focus:ring-primary-600 focus:border-primary-600 dark:border-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                              <option value="pending">Pending</option>
                              <option value="confirmed">Confirmed</option>
                          </select>
                      </td>
