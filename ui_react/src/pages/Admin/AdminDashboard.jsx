import { CalendarCheck, CalendarDays, IndianRupee, TabletSmartphone, Users } from 'lucide-react'
...
const AdminDashboard = () => {
  return (
    ...
    <div className='container px-24 py-8 mx-auto bg-purple-100'>
      <h1 className='text-3xl font-semibold text-center'>Welcome, Admin!</h1><br/><br/>
